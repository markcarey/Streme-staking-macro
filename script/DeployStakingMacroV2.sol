...
/**
 * @title DeployStakingMacroV2
 * @dev Deployment script for StakingMacroV2 contract
 * 
 ...
 */
contract DeployStakingMacroV2 is Script {
    function run(address _stakingHelper) external {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        
        vm.startBroadcast(deployerPrivateKey);
        
        StakingMacroV2 receiver = new StakingMacroV2(_stakingHelper);
        console.log("StakingMacroV2 deployed at:", address(receiver));
        vm.stopBroadcast();
    }
